    ...
    useEffect(() => {
        ...
        const fetchPlans = async () => {
            try {
                ...
                // 실제 API 경로/응답 구조에 맞게 수정!
                const res = await axios.get(`http://localhost:5001/api/planner/list?userId=${userId}`);
                setTravelPlans(res.data.plans); // plans 배열로 내려오도록 백엔드에서 맞춰주세요!
            } catch (err) {
